                ...
                children=[
                        ...
                        html.Div([                            
                                            ...
                                            html.Div([                                               
                                                                ...
                                                                html.Div(id='graph-output_01_mango', style={'display': 'inline-block', 'margin-top': '0%', 'margin-left': '-130%', 'margin-right': '0%', 'margin-bottom': '0%'}),
                                                                html.Div(id='graph-output_01_coconut', style={'display': 'inline-block', 'margin-top': '0%', 'margin-left': '-130%', 'margin-right': '0%', 'margin-bottom': '0%'}),
                                                ], className="two columns"),                                               
                ...
                dcc.Tab(label='Profil-2: Yasal Takip Yöneticisi', style={"color": "white","background": "#5D6D7E", 'textAlign': 'center', 'verticalAlign': 'middle','width':'100%', 'height' : 5, 'line-height' : 0 ,'margin-top':0 , 'margin-bottom':0 ,'margin-left' : 0,'display': 'inline-block', 'font-family': "Calibri" , 'font-size': '90%' ,'padding-left':'0%', 'justify-content': 'center', 'font-style': 'italic'},selected_style={"color": "white","background": "#1F1F25", 'textAlign': 'center', 'verticalAlign': 'middle', 'width':'100%', 'height' : 5, 'line-height' : 0 ,'margin-top':0 , 'margin-left' : 0,'display': 'inline-block', 'font-family': "Calibri" , 'font-size': '90%' ,'padding-left':'0%', 'justify-content': 'center', 'font-style': 'italic'},
                        ...
                        html.Div([
                                            ...
                                            html.Div([                                               
                                                                ...
                                                                html.Div(id='graph-output_02_apple', style={'display': 'inline-block', 'margin-top': '0%', 'margin-left': '0%', 'margin-right': '0%', 'margin-bottom': '0%'}),
                                                ], className="four columns"),                                            
                                            ...
                                            html.Div([                                               
                                                                ...
                                                                html.Div(id='graph-output_02_orange', style={'display': 'inline-block', 'margin-top': '0%', 'margin-left': '0%', 'margin-right': '0%', 'margin-bottom': '0%'}),
                                                ], className="five columns"),  
                        ...
                        html.Div([
                                            ...
                                            html.Div([                                               
                                                                ...
                                                                html.Div(id='graph-output_02_banana', style={'display': 'inline-block', 'margin-top': '0%', 'margin-left': '0%', 'margin-right': '0%', 'margin-bottom': '0%'}),
                                                ], className="six columns"),  
                                            
                                            
                                            html.Div([                                               
                                            
                                                                html.Div(id='graph-output_02_lemon', style={'display': 'inline-block', 'margin-top': '0%', 'margin-left': '40%', 'margin-right': '0%', 'margin-bottom': '0%'}),
                                                ], className="two columns"),                                            


                                            html.Div([                                               
                                            
                                                                html.Div(id='graph-output_02_cherry', style={'display': 'inline-block', 'margin-top': '0%', 'margin-left': '30%', 'margin-right': '0%', 'margin-bottom': '0%'}),
                                                ], className="four columns"),   
                        ...
                        html.Div([
                                            ...
                                            html.Div([                                               
                                                                ...
                                                                html.Div(id='graph-output_02_apricot', style={'display': 'inline-block', 'margin-top': '0%', 'margin-left': '0%', 'margin-right': '0%', 'margin-bottom': '0%'}),
                ...
                children=[
                        ...
                        html.Div([
                                            ...
                                            html.Div([                                               
                                                                ...
                                                                html.Div(id='graph-output_05_orange', style={'display': 'inline-block', 'margin-top': '0%', 'margin-left': '0%', 'margin-right': '0%', 'margin-bottom': '0%'}),
                                                                html.Div(id='graph-output_05_banana', style={'display': 'inline-block', 'margin-top': '0%', 'margin-left': '0%', 'margin-right': '0%', 'margin-bottom': '0%'}),
                                                ], className="five columns"),                                            
                                            ...
                                            html.Div([                                               
                                                                ...
                                                                html.Div(id='graph-output_05_lemon', style={'display': 'inline-block', 'margin-top': '0%', 'margin-left': '0%', 'margin-right': '0%', 'margin-bottom': '0%'}),
                                                                html.Div(id='graph-output_05_cherry', style={'display': 'inline-block', 'margin-top': '0%', 'margin-left': '0%', 'margin-right': '0%', 'margin-bottom': '0%'}),
                                                ], className="four columns"),  
                        ...
                        html.Div([                            
                                            ...
                                            html.Div([                                                
                                                                html.Div(id='graph-output_05_apricot_1', style={'display': 'inline-block', 'margin-top': '0%', 'margin-left': '10%', 'margin-right': '0%', 'margin-bottom': '0%'}),                                                
                                                ], className="two columns"),        
                                            
                                            html.Div([                                                
                                                                html.Div(id='graph-output_05_apricot_2', style={'display': 'inline-block', 'margin-top': '0%', 'margin-left': '-30%', 'margin-right': '0%', 'margin-bottom': '0%'}),                                                
                                                ], className="two columns"), 
                                            
                                            html.Div([                                                
                                                                html.Div(id='graph-output_05_apricot_3', style={'display': 'inline-block', 'margin-top': '0%', 'margin-left': '-60%', 'margin-right': '0%', 'margin-bottom': '0%'}),                                                
                                                ], className="two columns"), 
                                            
                                             html.Div([                                                
                                                                html.Div(id='graph-output_05_apricot_4', style={'display': 'inline-block', 'margin-top': '0%', 'margin-left': '-90%', 'margin-right': '0%', 'margin-bottom': '0%'}),                                                
                                                ], className="two columns"),       
                                            
                                             html.Div([                                                
                                                                html.Div(id='graph-output_05_apricot_5', style={'display': 'inline-block', 'margin-top': '0%', 'margin-left': '-120%', 'margin-right': '0%', 'margin-bottom': '0%'}),                                                
                                                ], className="two columns"),
                                             
                                            html.Div([                                               
                                            
                                                                html.Div(id='graph-output_05_mango', style={'display': 'inline-block', 'margin-top': '0%', 'margin-left': '-130%', 'margin-right': '0%', 'margin-bottom': '0%'}),
                                                                html.Div(id='graph-output_05_coconut', style={'display': 'inline-block', 'margin-top': '10%', 'margin-left': '-130%', 'margin-right': '0%', 'margin-bottom': '0%'})
                                                ], className="two columns"),                                               
...
#                        figure={
#                                    'data': [
#                                                {'x': (df_2_kredi_türü['Kredi Türü'].values.tolist()), 'y': (df_2_kredi_türü['NPL'].values.tolist()), 'type': 'scatter', 'name': df_2_kredi_türü['Kredi Türü'].values.tolist(),'mode': 'lines+markers+text', 'marker' : {'color': color_palette_blue[0]},'text' : df_2_kredi_türü['NPL'],'textposition':'top center', 'textfont':{'color':color_palette_blue[3]}, 'cliponaxis': False, 'hoverinfo' : 'x+text'}
#                                            ],
#                                    'layout':   {
#                                                    'height' : 200,
#                                                    'width' : 400,
...
#                        figure={
#                                    'data': [
#                                                {'x': (df_2_kredi_türü['Kredi Türü'].values.tolist()), 'y': (df_2_kredi_türü['NPL'].values.tolist()), 'type': 'bar', 'name': df_2_kredi_türü['Kredi Türü'].values.tolist(), 'marker' : {'color': color_palette_blue[0]},'text' : df_2_kredi_türü['NPL'],'textposition':'auto', 'textfont':{'color':'white'},'hoverinfo' : 'x+text'}
#                                            ],
#                                    'layout':   {
#                                                    'height' : 200,
#                                                    'width' : 400,
...
@app.callback([Output('card-output_02_apple', 'children'),Output('card-output_02_orange', 'children'),Output('card-output_02_banana', 'children'),Output('graph-output_02_apple', 'children'),Output('graph-output_02_orange', 'children'),Output('graph-output_02_banana', 'children'),Output('graph-output_02_lemon', 'children'),Output('graph-output_02_cherry', 'children'),Output('graph-output_02_apricot', 'children')],
              ...
              Input('Segment_Filtresi_tab2', 'value'),
              Input('Şube_Filtresi_tab2', 'value'),
              Input('Tahsilat_Ofisi_Filtresi_tab2', 'value')
               ]) 


def update_value_2(input_1, input_2, input_3, input_4, input_5):
        ...
        if input_5 == 'All':
            ...
            df_2 = df_2[df_2['Tahsilat Ofisi'] == input_5]
...
#                figure={
#                            'data': [
#                                                {'x': recovery_vintage_all['Ay'].values.tolist(), 'y': recovery_vintage_all['Tahsilat%'].values.tolist(), 'type': 'scatter',  'line': {'dash': 'dash'},'mode': 'lines+markers+text','marker' : {'color': color_palette_blue[0] },'text' : recovery_vintage_all['Tahsilat%%'].values.tolist(),'textposition':'top center', 'cliponaxis': False, 'hoverinfo': 'x+text'},
#                                            ],
#                            'layout':   {
#                                            'height' : 300,
#                                            #'max-height' : 275,
...
#                                            'paper_bgcolor': 'rgba(0,0,0,0)',
#                                            'font': {'color': '#5D6D7E'},
#                                            'xaxis': {'title':'Takipte Geçen Süre (Ay)','showgrid' : False, 'showline' : True, 'showticklabels' : True,'range': [0,12]},
#                                            'yaxis': {'title':'NPL Tahsilat (%)','showgrid' : False, 'showline' : True, 'showticklabels' : True, 'tickformat': ',.0%','range': [0,1.2*max(recovery_vintage_all['Tahsilat%'])]},
#                                            'margin' : {'l':90,'r': 40,'t': 40,'b': 40}
#                                        }
#                        }
...
#map-1 callback begins here
@app.callback([Output('map-output_01_apple', 'children'),Output('map-output_01_orange', 'children'),Output('map-output_01_banana', 'children'),Output('map-output_01_lemon', 'children')],
              [Input('Kredi Türü_Filtresi_map1', 'value'),
              Input('Segment_Filtresi_map1', 'value'),
              Input('Ay_Filtresi_map1', 'value')
               ]) 


def update_value_map_1(input_1, input_2, input_3):  
    ...
    df_2['Total Loans'] = df_2['Gecikmesiz'] + df_2['Bucket-1'] + df_2['Bucket-2'] + df_2['Bucket-3']
    df_2_sehir_nplpct = df_2.groupby(['Şehir'])['Total Loans'].sum(),df_2.groupby(['Şehir'])['NPL'].sum(),df_2.groupby(['Şehir'])['Tahsilat-12'].sum()
    df_2_sehir_nplpct = pd.DataFrame(list( df_2_sehir_nplpct))
    df_2_sehir_nplpct.reset_index(drop=True, inplace=True)
    df_2_sehir_nplpct = df_2_sehir_nplpct.T
    df_2_sehir_nplpct.reset_index(drop=False, inplace=True)
    df_2_sehir_nplpct = df_2_sehir_nplpct.rename(columns = {0:'Total Loans', 1:'NPL', 2:'Tahsilat'})
    df_2_sehir_nplpct['NPL Aktarım %'] = df_2_sehir_nplpct['NPL'] / df_2_sehir_nplpct ['Total Loans']
    df_2_sehir_nplpct['NPL Tahsilat %'] = df_2_sehir_nplpct['Tahsilat'] / df_2_sehir_nplpct['NPL']
    df_2_sehir_nplpct = df_2_sehir_nplpct.merge(coordinates,on='Şehir',how='left')
    df_2_sehir_nplpct['Size'] = 1
    
    df_2_sehir_nplpct = df_2_sehir_nplpct.sort_values(by=['NPL'], ascending = True)
    df_2_sehir_nplpct.reset_index(drop=True, inplace=True)
    df_2_sehir_nplpct['NPL Sıra'] = df_2_sehir_nplpct.index
    
    df_2_sehir_nplpct = df_2_sehir_nplpct.sort_values(by=['NPL Aktarım %'], ascending = True)
    df_2_sehir_nplpct.reset_index(drop=True, inplace=True)
    df_2_sehir_nplpct['NPL Aktarım % Sıra'] = df_2_sehir_nplpct.index
    
    df_2_sehir_nplpct = df_2_sehir_nplpct.sort_values(by=['Tahsilat'], ascending = True)
    df_2_sehir_nplpct.reset_index(drop=True, inplace=True)
    df_2_sehir_nplpct['Tahsilat Sıra'] = df_2_sehir_nplpct.index
    
    df_2_sehir_nplpct = df_2_sehir_nplpct.sort_values(by=['NPL Tahsilat %'], ascending = True)
    df_2_sehir_nplpct.reset_index(drop=True, inplace=True)
    df_2_sehir_nplpct['NPL Tahsilat % Sıra'] = df_2_sehir_nplpct.index
    ...
    return dcc.Graph(   
                ...
                figure = px.density_mapbox(
                                            ...
                                            range_color = [df_2_sehir_nplpct['NPL'].min() , df_2_sehir_nplpct['NPL'].max()],
                                            color_continuous_midpoint = df_2_sehir_nplpct['NPL'].median(),
                                            width = 900, 
                                            height = 350,
                                            hover_data=['Şehir'],
                                            title = 'Son 12 Ay NPL Aktarımları (M TL)',
                                            opacity = 0.55
                                            ).update_layout(
                                                            showlegend = True, 
                                                            paper_bgcolor = 'rgba(0,0,0,0)',
                                                            ...
                                                            coloraxis_colorbar=dict(title="NPL Aktarımı (M TL)")
                                                            ).update_traces(
                                                    hovertemplate = '{Şehir}'
                                                    )   
                                            ...
                                            zoom = 4.5,
                                            color_continuous_scale = 'reds',
                                            range_color = [df_2_sehir_nplpct['NPL Aktarım %'].min() , df_2_sehir_nplpct['NPL Aktarım %'].max()],
                                            color_continuous_midpoint = df_2_sehir_nplpct['NPL Aktarım %'].median(),
                                            width = 900, 
                                            height = 350,
                                            hover_data=['Şehir'],
                                            title = 'Aylık NPL Aktarım Oranı %',
                                            opacity = 0.35
                                            ).update_layout(
                                                            showlegend = True, 
                                                            paper_bgcolor = 'rgba(0,0,0,0)',
                                                            plot_bgcolor = 'rgba(0,0,0,0)',
                                                            margin={"r":0,"t":0,"l":0,"b":0},
                                                            coloraxis_colorbar=dict(title="Aylık NPL Aktarımı %", tickformat = ',.1%')
                                                            )                                                      
                                            ...
                                            range_color = [df_2_sehir_nplpct['Tahsilat'].min() , df_2_sehir_nplpct['Tahsilat'].max()],
                                            color_continuous_midpoint = df_2_sehir_nplpct['Tahsilat'].median(),
                                            width = 900, 
                                            height = 350,
                                            hover_data=['Şehir'],
                                            title = 'Son 12 Ay NPL Tahsilatı (M TL)',
                                            opacity = 0.65
                                            ).update_layout(
                                                            showlegend = True, 
                                                            paper_bgcolor = 'rgba(0,0,0,0)',
                                                            plot_bgcolor = 'rgba(0,0,0,0)',
                                                            margin={"r":0,"t":0,"l":0,"b":0},
                                                            coloraxis_colorbar=dict(title="NPL Tahsilat (M TL)")
                                                            )    
                     ),dcc.Graph(   
                                            ...
                                            zoom = 4.5,
                                            color_continuous_scale = 'greens',
                                            range_color = [df_2_sehir_nplpct['NPL Tahsilat %'].min() , df_2_sehir_nplpct['NPL Tahsilat %'].max()],
                                            color_continuous_midpoint = df_2_sehir_nplpct['NPL Tahsilat %'].median(),
                                            width = 870, 
                                            height = 350,
                                            hover_data=['Şehir'],
                                            title = '12 Ay NPL Tahsilat Oranı (%)',
                                            opacity = 0.40
                                            ).update_layout(
                                                            title = '12 Ay NPL Tahsilat Oranı (%)',
                                                            showlegend = True, 
                                                            ...
                                                            plot_bgcolor = 'rgba(0,0,0,0)',
                                                            margin={"r":0,"t":0,"l":0,"b":0},
                                                            coloraxis_colorbar=dict(title="NPL Tahsilat %", tickformat = ',.0%')
                                                            )    
...
#tab-5 callback begins here               
@app.callback([Output('card-output_05_apple', 'children'),Output('card-output_05_orange', 'children'),Output('graph-output_05_apple', 'children'),Output('graph-output_05_orange', 'children'),Output('graph-output_05_banana', 'children'),Output('graph-output_05_lemon', 'children'),Output('graph-output_05_cherry', 'children'),Output('graph-output_05_apricot_1', 'children'),Output('graph-output_05_apricot_2', 'children'),Output('graph-output_05_apricot_3', 'children'),Output('graph-output_05_apricot_4', 'children'),Output('graph-output_05_apricot_5', 'children'),Output('graph-output_05_mango', 'children'),Output('graph-output_05_coconut', 'children')],
              [Input('Şube_Filtresi_tab5', 'value'),
              Input('Bölge_Filtresi_tab5', 'value'),
              Input('Segment_Filtresi_tab5', 'value'),
              Input('Ay_Filtresi_tab5', 'value')
               ]) 


def update_value_5(input_1, input_2, input_3, input_4):  
    ...
    #card-output_05_apple
    return html.H1(total_NPL, style={"color": "white","background": color_palette_blue[3], 'textAlign': 'center', 'width':'75%', 'display': 'inline-block', 'font-family': "Calibri" , 'font-size': '250%' ,'justify-content': 'center', 'font-style': 'italic', 'margin-top': '-20%', 'margin-left': '22%'}
    
    

    #card-output_05_orange          
          ),html.H1(total_recovery, style={"color": "white","background": color_palette_blue[1], 'textAlign': 'center', 'width':'75%', 'display': 'inline-block', 'font-family': "Calibri" , 'font-size': '250%' ,'justify-content': 'center', 'font-style': 'italic', 'margin-top': '-20%', 'margin-left': '22%'}                              
   

                    
    #graph-output_05_apple          
